...
from apps.courses.views import CourseListView,CourseDetailView,CourseLessonView,CourseCommentsView,VideoPlayView
urlpatterns = [
    ...
    url(r'^(?P<course_id>\d+)/video/(?P<video_id>\d+)/', VideoPlayView.as_view(), name="video_play"),
